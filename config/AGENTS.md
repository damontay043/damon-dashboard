...
### 🧠 MEMORY.md Sync to Node
- MEMORY.md syncs to Scarlet2023 (bro's PC) when node is online
- Path: `/mnt/c/pj/clawdbot-shared/vps-config/MEMORY.md`
- This is PRIVATE (not on public GitHub) — only bro can read it
